...
const index_js_4 = require("../../persistent/index.js");
...
exports.default = async (req, res) => {
    ...
    if (props.handler) {
        ...
        const customHandlers = index_js_4.CoreContext.get("handlers");
    ...
    //database request...
    const customModels = index_js_4.CoreContext.get("models");
