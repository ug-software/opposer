...
exports.Context = exports.f = exports.IsPublicMethod = exports.IsPublic = exports.Payload = exports.Field = exports.Handler = exports.Method = exports.auth = void 0;
...
const index_js_6 = require("../persistent/index.js");
// Playground
...
async function Server(props) {
    ...
    index_js_6.CoreContext.set("db", db);
    index_js_6.CoreContext.set("models", props.models);
    index_js_6.CoreContext.set("handlers", props.handlers);
...
Object.defineProperty(exports, "Handler", { enumerable: true, get: function () { return index_js_8.Handler; } });
...
var index_js_9 = require("../persistent/index.js");
Object.defineProperty(exports, "Context", { enumerable: true, get: function () { return index_js_9.CoreContext; } });
