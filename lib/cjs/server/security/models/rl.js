...
__decorate([
    (0, index_js_1.Field)(() => (0, index_js_1.f)().string("schema is string.").required("schema is required.")),
    __metadata("design:type", String)
], Role.prototype, "sm", void 0);
__decorate([
    (0, index_js_1.Field)(() => (0, index_js_1.f)().string("method is string.").required("method is required.")),
    __metadata("design:type", String)
