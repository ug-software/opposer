...
const urs_js_1 = __importDefault(require("./urs.js"));
let Role = class Role extends schema_js_1.default {
};
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => urs_js_1.default, (user) => user.rl),
    __metadata("design:type", urs_js_1.default)
