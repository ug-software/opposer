...
export class ValidationBuilder {
    string(message) { return new StringValidator(message); }
    number(message) { return new NumberValidator(message); }
    boolean(message) { return new BooleanValidator(message); }
    date(message) { return new DateValidator(message); }
    json(schema) { return new JsonValidator(schema); }
}
