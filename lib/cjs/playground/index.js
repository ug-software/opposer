...
async function generateMap(server, modelsPath, handlersPath) {
    var map = {
        models: {},
        handlers: {},
    };
    var allModels = await index_js_1.default.getAllModels();
    ...
    var allHandlers = await index_js_1.default.getAllHandlers(handlersPath);
